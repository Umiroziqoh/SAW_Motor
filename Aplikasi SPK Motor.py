...
with st.form("input_form"):
    harga_max = st.number_input("1. Berapa harga maksimal motor yang Anda inginkan? (dalam Rp juta)", 
                                min_value=10.0, max_value=50.0, value=30.0, step=0.5)
...
if submitted:
    # Data Alternatif Motor (Harga dalam juta)
    data = {

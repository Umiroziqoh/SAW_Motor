...
with st.form("input_form"):
    harga_max = st.number_input("1. Berapa harga maksimal motor yang Anda inginkan? (dalam Rp ribu)", min_value=10000, max_value=50000, value=30000)
